                        ...
                        <form className="w-full max-w-2xl bg-white p-8 rounded-lg shadow-md space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="name"
                                    required
                                    className="w-full px-4 py-2 bg-black text-white border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-900"
                                />
                            </div>
                            <div>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-slate-800 mb-1" htmlFor="location">Location</label>
                                <input
                                    type="text"
                                    id="location"
                                    name="location"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-slate-800 mb-1" htmlFor="message">Message</label>
                                <textarea
                                    id="message"
                                    name="message"
                                    rows="4"
